...
type Config struct {
	...
	// UsagePersistenceFile optionally stores/restores usage statistics snapshots as JSON.
	UsagePersistenceFile string `yaml:"usage-persistence-file" json:"usage-persistence-file"`
